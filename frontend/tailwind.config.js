    ...
    extend: {
      ...
      keyframes: {
        ...
        glowPulse: {
          ...
          '50%': { boxShadow: '0 0 40px rgba(255, 69, 0, 0.5)' },
        },
      },
      boxShadow: {
        'glass': '0 8px 32px rgba(0, 0, 0, 0.3)',
        'glow': '0 0 30px rgba(255, 69, 0, 0.3)',
        'glow-lg': '0 0 60px rgba(255, 69, 0, 0.4)',
        'brutalist-sm': '2px 2px 0px 0px rgba(0, 0, 0, 1)',
        'brutalist': '4px 4px 0px 0px rgba(0, 0, 0, 1)',
        'brutalist-lg': '8px 8px 0px 0px rgba(0, 0, 0, 1)',
        'brutalist-white-sm': '2px 2px 0px 0px rgba(255, 255, 255, 1)',
        'brutalist-white': '4px 4px 0px 0px rgba(255, 255, 255, 1)',
        'brutalist-white-lg': '8px 8px 0px 0px rgba(255, 255, 255, 1)',
        'brutalist-accent': '4px 4px 0px 0px #ff4500',
        'brutalist-accent-lg': '8px 8px 0px 0px #ff4500',
      },
      backdropBlur: {
        xs: '2px',
      },
